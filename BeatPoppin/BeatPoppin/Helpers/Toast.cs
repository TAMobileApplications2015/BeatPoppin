namespace BeatPoppin.Helpers
{
    ...
    public static class Toast
    {
        ...
        private static readonly string[] toastMessageIconPaths = new string[]
        {
            "ms-appx:///Icons/appbar.smiley.frown.png",
            "ms-appx:///Icons/appbar.smiley.happy.png"
        };

        public static void Message(string title, string content, ToastMessageIconsEnum icon)
        {
            //    string title = "Andrew sent you a picture";
            //    string content = "Check this out, Happy Canyon in Utah!";
            //string image = "http://blogs.msdn.com/cfs-filesystemfile.ashx/__key/communityserver-blogs-components-weblogfiles/00-00-01-71-81-permanent/2727.happycanyon1_5B00_1_5D00_.jpg";
            string logo = toastMessageIconPaths[(int)icon];
